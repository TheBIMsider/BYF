...
class BribeYourselfFitFirebase {
  ...
  async loadFromFirebase() {
    ...
    try {
      ...
      // Get current user ID (or use 'user1' as default like Airtable version)
      const userId = this.firebaseConfig.currentUser?.uid || 'user1';
      const userRef = this.firebaseConfig.database.ref(`users/${userId}`);
  ...
  async saveUserToAirtable() {
    ...
    try {
      ...
      const existingResponse = await fetch(
        `https://api.airtable.com/v0/${this.firebaseConfig.baseId}/Users?filterByFormula={User ID}='user1'`,
        {
          headers: {
            Authorization: `Bearer ${this.firebaseConfig.token}`,
          },
        }
      );
  ...
  async createUserRecord() {
    ...
    const response = await fetch(
      `https://api.airtable.com/v0/${this.firebaseConfig.baseId}/Users`,
      {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${this.firebaseConfig.token}`,
  ...
  async updateUserRecord(recordId) {
    ...
    const response = await fetch(
      `https://api.airtable.com/v0/${this.firebaseConfig.baseId}/Users/${recordId}`,
      {
        method: 'PATCH',
        headers: {
          Authorization: `Bearer ${this.firebaseConfig.token}`,
  ...
  async saveDailyLogsToAirtable() {
    ...
    for (const log of logEntries) {
      ...
      try {
        const existingResponse = await fetch(
          `https://api.airtable.com/v0/${this.firebaseConfig.baseId}/Daily%20Logs?filterByFormula=IS_SAME(Date,'${searchDate}','day')`,
          {
            headers: {
              Authorization: `Bearer ${this.firebaseConfig.token}`,
            },
  ...
  async createDailyLogRecord(log) {
    ...
    const response = await fetch(
      `https://api.airtable.com/v0/${this.firebaseConfig.baseId}/Daily%20Logs`,
      {
        method: 'POST',
        headers: {
          Authorization: `Bearer ${this.firebaseConfig.token}`,
  ...
  async updateDailyLogRecord(recordId, log) {
    ...
    const response = await fetch(
      `https://api.airtable.com/v0/${this.firebaseConfig.baseId}/Daily%20Logs/${recordId}`,
      {
        method: 'PATCH',
        headers: {
          Authorization: `Bearer ${this.firebaseConfig.token}`,
  ...
  async saveSettingsToAirtable() {
    try {
      ...
      const existingResponse = await fetch(
        `https://api.airtable.com/v0/${this.firebaseConfig.baseId}/Settings?filterByFormula={Setting Name}='user1_settings'`,
        {
          headers: {
            Authorization: `Bearer ${this.firebaseConfig.token}`,
          },
      ...
      if (existingResponse.ok) {
        ...
        if (existingData.records.length > 0) {
          ...
          if (settingsChanged) {
            ...
            const response = await fetch(
              `https://api.airtable.com/v0/${this.firebaseConfig.baseId}/Settings/${recordId}`,
              {
                method: 'PATCH',
                headers: {
                  Authorization: `Bearer ${this.firebaseConfig.token}`,
          ...
          const response = await fetch(
            `https://api.airtable.com/v0/${this.firebaseConfig.baseId}/Settings`,
            {
              method: 'POST',
              headers: {
                Authorization: `Bearer ${this.firebaseConfig.token}`,
  ...
  async saveCustomRewardsToAirtable() {
    ...
    try {
      ...
      const existingResponse = await fetch(
        `https://api.airtable.com/v0/${this.firebaseConfig.baseId}/Custom%20Rewards`,
        {
          headers: {
            Authorization: `Bearer ${this.firebaseConfig.token}`,
          },
  ...
  async saveAchievementsToAirtable() {
    ...
    try {
      ...
      const existingResponse = await fetch(
        `https://api.airtable.com/v0/${this.firebaseConfig.baseId}/Achievements`,
        {
          headers: {
            Authorization: `Bearer ${this.firebaseConfig.token}`,
          },
  ...
  async checkConnectionHealth() {
    ...
    try {
      ...
      const response = await fetch(
        `https://api.airtable.com/v0/meta/bases/${this.firebaseConfig.baseId}/tables`,
        {
          method: 'HEAD',
          headers: { Authorization: `Bearer ${this.firebaseConfig.token}` },
        }
      );
